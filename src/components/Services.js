      ...
      <div className="w-1/2 p-10">
        ...
        {open1 ? (
          <div className="w-full flex justify-between border-b-2 border-t-2 py-5 cursor-pointer">
            <div className="mx-10 " onClick={() => setOpen1(!open1)}>
              <div className="mb-5 text-xl font-bold">TRIMMING</div>
              Tree trimming is important for trees of all ages. Done improperly,
              the tree can be damaged permanently. Tyler has extensive
              experience in trimming trees to:
              <ul>
                <li>- prevent decay</li>
        ...
        {open2 ? (
          <div className="w-full flex justify-between border-b-2 py-5 cursor-pointer">
            <div className="mx-10 " onClick={() => setOpen2(!open2)}>
              <div className="mb-5 text-xl font-bold">FIREWOOD & MULCH</div>
              Now offering firewood for campfires, mulching, and more! Contact
        ...
        {open3 ? (
          <div className="w-full flex justify-between border-b-2  py-5 cursor-pointer">
            <div className="mx-10 " onClick={() => setOpen3(!open3)}>
              <div className="mb-5 text-xl font-bold">
                STUMP GRINDING & REMOVAL
              </div>
              Leave your stump grinding and removal to Tyler's expertise. Power
              lines, in-ground sprinklers, and other obstacles will be
              professionally assessed before safely grinding your tree stump up
              to eight inches below the ground.
            </div>
            <div className="mx-10 text-2xl">+</div>
          </div>
        ) : (
