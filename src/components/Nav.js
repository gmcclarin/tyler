const Nav = () => {
    return (
        <nav className="sm:hidden fixed z-50 top-0 font-sans flex flex-col text-center sm:flex-row sm:text-left sm:justify-between py-4 px-6 bg-accent shadow sm:items-baseline w-full">
